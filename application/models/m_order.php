<?php
	...
	class M_order extends CI_Model {
       ...
       /*     if (!$all) {
	    ...
	    {
	    	$this->db->select('ord.or_id , ord.us_id , us1.us_username , cl.cl_id , cl.cl_name, ord.or_acc , cl.cl_country , ord.or_date ,ord.pr_id, pr.pr_desc , pr.pr_color, ord.or_paid , orex.or_trackno , orex.or_shipcom , orex.or_dateline');
	    ...
	    {
	    	$this->db->select('ord.or_id , ord.us_id , us1.us_username , cl.cl_id , cl.cl_name ,cl.cl_country, ord.or_acc ,ord.or_date ,ord.pr_id, pr.pr_desc , pr.pr_color, ord.or_paid  , orex.or_trackno , orex.or_shipcom , orex.or_dateline');
	    	$this->db->from('order ord');
	    	if($del != 3){
	    		$this->db->where('ord.or_del', $del);
	    	}

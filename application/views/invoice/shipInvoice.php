  ...
  <section class="contemporary-template__metadata">
    <div class="pull-left">
      <div class="contemporary-template__metadata__customer--billing">
        ...
        <strong><?= $arr['ship']->cl_name; ?></strong>
    ...
    <div class="pull-right">
      <table class="wv-table">
        ...
        <tr class="wv-table__row">
          ...
          <td class="wv-table__cell" style="text-align: right;">
          <?php 
            $temp = date_create($arr['ship']->sh_date);
          ?>
        ...
        <tr class="wv-table__row">
          <td class="wv-table__cell" style="text-align: right;">
            <strong class="wv-text--strong">Checked By : </strong>
          </td>
          <td></td>
          <td class="wv-table__cell" style="text-align: right;">          
  ...
  <div class="contemporary-template__items">
    <table class="table">
      <thead style="background-color: #FFFFFF;">
        <tr>
          <th colspan="12" style="color: #000000;" align="center">Item Details</th>
      ...
      <tbody>
         ...
         <tr>
          <td colspan="12" style="color: #000000;">
          	<strong><?= $key->ty2_desc; ?></strong>
          	<br>
			     <?= $key->ca_desc; ?> | <?= $key->ni_mg; ?>mg
          </td>
          <td colspan="1" style="color: #000000;" style="width:60px;"><?= $key->si_qty; ?></td>
          <td colspan="1" style="color: #000000;" style="width:60px;"><?= $key->si_price; ?></td>
          
          <td colspan="1" style="color: #000000;" style="width:60px;"><?= $duit; ?> <?= number_format((float)$total=$key->si_qty * $key->si_price, 2, '.', '');?></td>
        ...
        <?php 
          ...
          if ($arr['ship']->sh_traking == null || $arr['ship']->sh_traking == '0000-00-00 00:00:00') {
            $arr['ship']->sh_traking = 0;
          }
          $total_all += $arr['ship']->sh_traking;           
        } ?>
         <tr>
        <td style="color: #000000;text-align: right;" colspan="14"><strong>Total :</strong></td>
          <td style="color: #000000;"><?= $duit; ?> <?php echo number_format((float)$total_all, 2, '.', ''); ?></td>
        </tr>
         <tr>
        	  <tr>
        <td style="color: #000000;text-align: right;" colspan="14">Shipping :</td>
          <td style="color: #000000;"><?= $duit; ?> <?= number_format((float)$arr['ship']->sh_traking, 2, '.', '');?></td>
        </tr>
          <td style="color: #000000;text-align: right;" colspan="14"> <strong>Amount Due :</strong></td>

...
<div class="readonly-payment-information_details">
    <!--     <div class="readonly-payment-information__details__items">
          ...
          Invoice <?php $code = 100000 + $arr['ship']->sh_id; echo "#".$code; ?>-D
        &nbsp;&nbsp;&nbsp;&nbsp;
        </div>
        <div class="readonly-payment-information__details__items">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
          Due on:
           <?php if($arr['ship']->sh_dateline != '0000-00-00 00:00:00'){ echo date_format(date_create($arr['ship']->sh_dateline) , 'd-M-Y' );}else{echo '--Not Set--';} ?>
          </div>
        </div>
      </div> -->
    ...
    <table class="table" id="mytable">
      <thead style="background-color: #FFFFFF;">
        <tr>
          ...
          <th style="color: #000000;">Amount(<?= $duit?>)</th>
        </tr>
      </thead>
      ...
      ?>
          ...
          <td style="color: #000000;"><input type="text" id="quantity" style="width:60px;" name="quantity" class="w3-input w3-border-0" required value="<?= $key->si_qty; ?>" ></td>
          <td style="color: #000000;"><input type="text" id="price" style="width:60px;" name="price" class="w3-input w3-border-0" required value="<?= number_format((float)$key->si_price, 2, '.', '');; ?>" ></td>
        ...
        $total=$a*$b;
         ?>
          <td style="color: #000000;"><input type="text" id="total" style="width:80px;" name="total" class="w3-input w3-border-0" required value="<?= number_format((float)$total=$key->si_qty * $key->si_price, 2, '.', '');?>" >

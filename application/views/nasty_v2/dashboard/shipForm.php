           ...
           <div class="tab-pane active" id="tab_1">
                        <div class="portlet box red-soft ribbon mt-element-ribbon" >
                            <div class="portlet-title">
                                <div class="caption">
                                    <img src="<?= base_url(); ?>/assets/cover/favicon2.png"> Shipping Form                                   
                                </div>
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="<?= site_url('nasty_v2/dashboard/page/z12'); ?>" method = "post" class="horizontal-form">
                                <input type="hidden" name="pr_id" id="pr_id" class="form-control" value="14">
                                    <div class="form-body" >                                    
                                    	<div class="row">                                          
                                    		<div class="form-group">
		                                	<label for="input" class="col-sm-2 control-label">Existing Shipper :</label>
		                                	<div class="col-sm-2">
                                        ...
                                        <div class="row">
                                        	<div class="portlet box" style="border: 1px solid #3246d2;">
				                                <div class="portlet-title"  style="background-color: #3246d2;">
				                                    <div class="caption">
				                                        <i class="fa fa-cogs"></i>Shipping Item List</div>

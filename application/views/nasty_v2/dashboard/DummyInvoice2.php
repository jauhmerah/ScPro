...
<head>
	...
	<link rel='stylesheet' type='text/css' href="<?= base_url(); ?>/asset/css/print.css" />
	<!-- <link rel='stylesheet' type='text/css' href='css/print.css' media="print" /> -->
	<script src="<?= base_url(); ?>asset/js/example.js"></script>
	<script src="<?= base_url(); ?>asset/js/jquery-1.3.2.min.js"></script>

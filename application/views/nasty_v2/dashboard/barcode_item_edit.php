	...
	<div class="col-md-12">
		<div class="portlet box blue">
            ...
            <div class="portlet-body form">
                ...
                <form class="form-horizontal" role="form" action="<?= site_url('nasty_v2/dashboard/updateFinish') ?>" method = 'post'>
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="barcode" class="form-control input-circle" value="<?= $arr->bi_code; ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php foreach ($cat as $key) {                                
                                        ?>
                                        <option value="<?= $key->ca_id; ?>" <?php if($key->ca_id == $arr->ca_id){echo " selected ";} ?> > <?= $key->ca_desc; ?></option>
                                        <?php
                                    } ?>
                                    </select>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php foreach ($type2 as $key) {    
                                        ...
                                        ?>
                                        <option value="<?= $key->ty2_id; ?>" <?php if($key->ty2_id == $arr->ty2_id){echo " selected ";} ?> > <?= $key->ty2_desc; ?></option>
                                        <?php
                                    }} ?>
                                    </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <?php foreach ($nico as $key) {                                
                                            ?>
                                            <?php if ($key->ni_mg == -1) { ?>
                                                <option value="<?= $key->ni_id; ?>" <?php if($key->ni_id == $arr->ni_id){echo " selected ";} ?> > No Mg</option>
                                            <?php }else { ?>                                          
                                                <option value="<?= $key->ni_id; ?>" <?php if($key->ni_id == $arr->ni_id){echo " selected ";} ?> > <?= $key->ni_mg; ?> Mg</option>
                                            <?php }?>
                                            <?php
                                        } ?>
                                        </select>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <input type="hidden" name="id" id="inputId" class="form-control" value="<?= $this->my_func->scpro_encrypt($arr->bi_id); ?>">

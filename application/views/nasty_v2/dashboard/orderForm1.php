						                                ...
						                                <table class="table table-striped table-condensed table-bordered">	                                    
						                                    <tbody>
						                                        ...
						                                        <tr>
					                                            	...
					                                            	<td>
					                                <button type="button" class="btn blue"><i class="fa fa-print"></i>&nbsp;&nbsp;Invoice Link</button>
					                                            	</td>
						                                        </tr>
						                                        <tr>
					                                            	<th>
					                                            	...
					                                            	<td>
					                        <button type="button" class="btn blue"><i class="fa fa-print"></i>&nbsp;&nbsp;Dummy Invoice</button>
					                                            	</td>
						                                        </tr>						                                                                             
						                                    </tbody>
						                                </table>

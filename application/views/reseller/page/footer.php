<!-- BEGIN FOOTER -->
        <div class="page-footer">
            <div class="page-footer-inner"> 2017 &copy; MyNastyRS By
                <a href="mailto:it@nastyjuice.com"><i class="fa fa-lightbulb-o"></i> NSTY_DakIT</a> &nbsp;|&nbsp;
                <a href="mailto:customersupport@nastyjuice.com"><i class="fa fa-life-ring"></i> Customer Support</a>

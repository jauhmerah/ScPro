...
<div class="row">
	<div class="col-md-12">
		...
		<div class="portlet box" style="background-color: #feb800; border: 1px solid #feb800; border-top: 0;">
            ...
            <div class="portlet-body flip-scroll">
	            ...
	            <form id="formSearch" action="<?= site_url('reseller/page/c1'); ?>" method="POST" role="form">
	            	<div class="col-md-12">
	            		<div class="col-md-2">
	            			<a href="<?= site_url('reseller/page/b1'); ?>"><button type="button" class="btn btn-primary btn-circle"><i class="fa fa-plus"></i> Add Order</button></a>
	            		</div>
	            		<div class="col-md-4">
	            		...
	            		<table class="table table-bordered table-striped flip-content">
		                    ...
		                    <?php
		                    	...
		                    	<tr>
		                            ...
		                            <td><?php 
		                            if ($user->or_id) {
		                            	$id = 'MY-'.(100000+$user->or_id);
		                            	echo '<span style = "color : #7200fe;"><strong>'.$id.'</strong></span>';
		                            } else {
		                            	echo "--Not Set--";
		                            }
                                    ?></td>

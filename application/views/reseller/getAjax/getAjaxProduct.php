...
<div class="col-md-3 col-xs-3 product" style="display: none;">
    <div class="mt-card-item">    
        ...
        <div class="mt-card-content">
            <h4 class="mt-card-name"><?= $arr->oip_desc; ?></h4>            
            <div class="clearfix">
            &nbsp;
            </div>
            <?php $price = number_format((float)$arr->oip_price, 2, '.', ''); ?>
            <p class="mt-card-desc font-grey-mint">ID <?= $arr->oip_code; ?><br>Price : RM <?= $price; ?></p>
            <div class="mt-card-social">                
                    <button type="button" class="btn btn-block yellow-gold">SELECT</button>
                <div class = "clearfix">&nbsp;</div>
            </div>
